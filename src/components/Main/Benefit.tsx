...
const Benefit = () => {
  ...
  const benefits = [
    {
      icon: <IoBuildOutline className="text-7xl" />,
    ...
    {
      icon: <MdSupportAgent className="text-7xl" />,
    ...
    {
      icon: <AiOutlineEyeInvisible className="text-7xl" />,
    ...
    {
      icon: <GiPadlockOpen className="text-7xl" />,
    ...
    {
      icon: <GiTeacher className="text-7xl" />,
  ...
  return (
    <section id="benefit" className="font-brush px-20 overflow-hidden text-[#3c3b3a] space-y-16 py-40 bg-[#F5F4E2]">
      <h1 className="font-black text-6xl">What benefit will you get?</h1>
      <div
        ref={listRef}
